...
#define MCSDL_GPIO_SCL_SET_OUTPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE)
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE)

#define MCSDL_GPIO_SDA_SET_OUTPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE)
#define MCSDL_GPIO_SDA_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE)
