...
static struct struct_marks_ver_mark marks_ver_mark = {
  ...
  .this=(&marks_ver_mark + 0x400000),
  .first_size=58*1024*1024,
  .first_start_addr=0x400000,
  .second_size=136*1024*1024,
  .second_start_addr=0x07800000,
  .third_size=256*1024*1024,
  .third_start_addr=0x40000000
};
#endif
...
#ifdef CONFIG_APPLY_GA_SOLUTION
	/* Mark for GetLog */
	plat_log_mark.p_main   = _buf_log_main+0x400000;
	plat_log_mark.p_radio  = _buf_log_radio+0x400000;
	plat_log_mark.p_events = _buf_log_events+0x400000;
	plat_log_mark.p_system = _buf_log_system+0x400000;	
